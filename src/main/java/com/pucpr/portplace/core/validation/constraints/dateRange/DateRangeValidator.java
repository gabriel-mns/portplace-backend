package com.pucpr.portplace.core.validation.constraints.dateRange;
...
public class DateRangeValidator implements ConstraintValidator<ValidDateRange, Object> {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        try {
            ...
            var startDate = (LocalDate) startDateDescriptor.getReadMethod().invoke(value);
            var endDate = (LocalDate) endDateDescriptor.getReadMethod().invoke(value);
