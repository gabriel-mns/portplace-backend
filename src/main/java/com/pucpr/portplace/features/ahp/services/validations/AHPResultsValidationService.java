...
import com.pucpr.portplace.features.ahp.exceptions.NoEvaluationsException;
...
import com.pucpr.portplace.features.ahp.specs.EvaluationGroupHasEvaluationsSpecification;
...
public class AHPResultsValidationService {
    ...
    private EvaluationGroupHasEvaluationsSpecification evaluationGroupHasEvaluationsSpecification;
    ...
    public void validateBeforeGet(Long evaluationGroupId) {
        ...
        if(!evaluationGroupHasEvaluationsSpecification.isSatisfiedBy(eg)) {
            throw new NoEvaluationsException(evaluationGroupId);
        }
